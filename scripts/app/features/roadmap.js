/**
 * RelayOne roadmap — the feature list shown in the "What's new" modal.
 * `status`: "live" (usable now) | "soon" (planned, needs more backend work).
 */
export const ROADMAP = [
  ...
  { icon: "📞", title: "Calls", status: "live", desc: "1:1 and group audio/video calls over WebRTC." },
  { icon: "🖼️", title: "Media viewer", status: "live", desc: "In-app image lightbox and file preview (PDF, video, audio, text)." },
  { icon: "🧵", title: "Threads", status: "live", desc: "Open a discussion of replies under any message." },
  { icon: "✏️", title: "Rich editor", status: "live", desc: "Markdown, formatting toolbar, emoji picker and edit history." },
